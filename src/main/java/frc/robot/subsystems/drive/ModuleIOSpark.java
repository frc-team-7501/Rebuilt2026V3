...
public class ModuleIOSpark implements ModuleIO {
  ...
  public ModuleIOSpark(int module) {
    ...
    turnEncoder =
        new CANcoder(
            switch (module) {
              case 0 -> frontLeftTurnCANcoderCanId;
              case 1 -> frontRightTurnCANcoderCanId;
              case 2 -> backLeftTurnCANcoderCanId;
              case 3 -> backRightTurnCANcoderCanId;
              default -> 0;
            });
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    sparkStickyFault = false;
    ifOk(turnSpark,
         ()-> turnEncoder.getPosition().getValueAsDouble(),
